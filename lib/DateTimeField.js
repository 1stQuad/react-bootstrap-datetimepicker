...
var DateTimeField = (function (_Component) {
  ...
  _createClass(DateTimeField, [{
    ...
    value: function formatValueForEvent(eventName, event) {
      ...
      var inputDate = (0, _moment2['default'])(value, this.state.inputFormat, true).isValid() ? (0, _moment2['default'])(value, this.state.inputFormat, true) : (0, _moment2['default'])(this.state.inputValue, this.state.inputFormat, true);
