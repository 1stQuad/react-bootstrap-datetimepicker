...
var DateTimePickerTime = (function (_Component) {
    ...
    function DateTimePickerTime() {
        ...
        this.setSelectedMinute = function (event) {
            _this.goBack();
            _this.props.setSelectedMinute(event);
        };

        this.setSelectedHour = function (event) {
            _this.goBack();
            _this.props.setSelectedHour(event);
        };

        this.renderMinutes = function () {
            if (_this.state.minutesDisplayed) {
                return _react2['default'].createElement(_DateTimePickerMinutes2['default'], _extends({}, _this.props, {
                    setSelectedMinute: _this.setSelectedMinute,
        ...
        this.renderHours = function () {
            if (_this.state.hoursDisplayed) {
                return _react2['default'].createElement(_DateTimePickerHours2['default'], _extends({}, _this.props, {
                    setSelectedHour: _this.setSelectedHour,
                    onSwitch: _this.goBack }));
            } else {
                return null;
            }
        ...
        this.renderPicker = function () {
            console.log(_this.props.unlimited);
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                                ...
                                _react2['default'].createElement('td', { className: 'separator', hidden: !_this.props.showPeriod })
                            ),
                            _react2['default'].createElement(
                                'tr',
                                null,
                                _react2['default'].createElement(
                                    ...
                                    _react2['default'].createElement(
                                        ...
                                        !_this.props.unlimited && _this.props.selectedDate.format('HH'),
                                        _this.props.unlimited && _this.props.selectedDate.diff((0, _moment2['default'])(0), 'h')
                                    )
                                ),
                                _react2['default'].createElement(
                                    'td',
