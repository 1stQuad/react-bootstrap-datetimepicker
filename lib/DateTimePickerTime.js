  ...
  function DateTimePickerTime() {
    ...
    this.renderMinutes = function () {
      if (_this.state.minutesDisplayed) {
        return _react2['default'].createElement(_DateTimePickerMinutes2['default'], _extends({}, _this.props, { setSelectedMinute: _this.setSelectedMinute, onSwitch: _this.goBack }));
      } else {
        return null;
      }
    };
    ...
    this.renderHours = function () {
      if (_this.state.hoursDisplayed) {
        return _react2['default'].createElement(_DateTimePickerHours2['default'], _extends({}, _this.props, { setSelectedHour: _this.setSelectedHour, onSwitch: _this.goBack }));
      } else {
        return null;
      }
    };
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _this.props.selectedDate.format('HH')
                  )
                ),
                _react2['default'].createElement(
                  'td',
