...
var DateTimePickerDays = (function (_Component) {
    ...
    function DateTimePickerDays() {
        ...
        this.renderDays = function () {
            ...
            while (prevMonth.isBefore(nextMonth)) {
                ...
                if (!classes.softDisabled && _this.props.availableDatesString) {
                    var date = prevMonth.toDate();
                    if (_this.props.availableDatesString.indexOf('' + date.getUTCDate() + date.getUTCMonth() + date.getUTCFullYear()) === -1) classes.softDisabled = true;
                }
    ...
    _createClass(DateTimePickerDays, [{
        ...
        value: {
            ...
            availableDatesString: _propTypes2['default'].string
        },
        enumerable: true
    }, {
        key: 'defaultProps',
