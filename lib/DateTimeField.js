...
var DateTimeField = (function (_Component) {
  ...
  function DateTimeField(props) {
    ...
    this.checkIsValid = function (value) {
      var date = (0, _moment2['default'])(value, _this.state.inputFormat, true);
      if (date.isValid()) {
        var min = _this.props.minDate ? date.isAfter(_this.props.minDate.clone().subtract(1, 'days')) : true;
        var max = _this.props.maxDate ? date.isBefore(_this.props.maxDate.clone().add(1, 'days')) : true;
        return min && max;
      } else {
        return false;
      }
    ...
    this.subtractMinute = function () {
      return _this.setState({
        ...
        _this.props.onChange(_this.state.selectedDate, 'click');
        return _this.setState({
  ...
  _createClass(DateTimeField, [{
    ...
    key: 'propTypes',
    value: {
      dateTime: _propTypes2['default'].oneOfType([_propTypes2['default'].string, _propTypes2['default'].number, _propTypes2['default'].instanceOf(_moment2['default']), _propTypes2['default'].instanceOf(Date)]),
