...
describe('DateTimePickerHours', function() {
  ...
  describe('Controls', function() {
    ...
    it('calls setSelectedHour when clicking a hour', function() {
      const hour = TestUtils.scryRenderedDOMComponentsWithClass(
        hours,
        'hour',
      )[0];
  ...
  describe('UI', function() {
    ...
    it('renders 24 Hours', function() {
      ...
      const hourList = TestUtils.scryRenderedDOMComponentsWithClass(
        hours,
        'hour',
      );
    ...
    it('renders 01 to 24', function() {
      ...
      expect(hourList.map(x => x.textContent)).toEqual([
        '01',
        '02',
        '03',
        '04',
