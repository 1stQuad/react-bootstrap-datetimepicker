...
describe('DateTimePickerMinutes', function() {
  ...
  describe('Controls', function() {
    ...
    it('calls setSelectedMinute when clicking a minute', function() {
      const minute = TestUtils.scryRenderedDOMComponentsWithClass(
        minutes,
        'minute',
      )[0];
    ...
    it('calls onSwitch when clicking the switch', function() {
      const switchIcon = TestUtils.findRenderedDOMComponentWithClass(
        minutes,
        'picker-switch',
      );
  ...
  describe('UI', function() {
    ...
    it('renders the switch if mode is time', function() {
      ...
      const switchList = TestUtils.scryRenderedDOMComponentsWithClass(
        minutes,
        'list-unstyled',
      );
    ...
    it('renders 12 different Minutes', function() {
      ...
      const minuteList = TestUtils.scryRenderedDOMComponentsWithClass(
        minutes,
        'minute',
      );
    ...
    it('renders 01 to 24', function() {
      ...
      expect(minuteList.map(x => x.textContent)).toEqual([
        '00',
        '05',
        '10',
        '15',
